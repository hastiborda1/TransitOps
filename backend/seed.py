...
def seed_db():
    ...
    # Seed Vehicles
    vehicles_data = [
        {"plate": "TX-4821", "make": "Volvo", "model": "FH16", "year": 2022, "type": "Truck", "status": "On Trip", "odometer": 128430, "fuel_type": "Diesel", "driver": "James Carter", "max_load": 15000, "acquisition_cost": 85000, "region": "North"},
        {"plate": "TX-9012", "make": "Mercedes", "model": "Actros", "year": 2021, "type": "Truck", "status": "In Shop", "odometer": 214800, "fuel_type": "Diesel", "driver": "Priya Shah", "max_load": 15000, "acquisition_cost": 85000, "region": "North"},
        {"plate": "TX-1145", "make": "Ford", "model": "Transit", "year": 2023, "type": "Van", "status": "On Trip", "odometer": 45200, "fuel_type": "Diesel", "driver": "Mia Nguyen", "max_load": 2500, "acquisition_cost": 35000, "region": "South"},
        {"plate": "TX-7788", "make": "Tesla", "model": "Semi", "year": 2024, "type": "Truck", "status": "Available", "odometer": 12030, "fuel_type": "Electric", "max_load": 15000, "acquisition_cost": 150000, "region": "West"},
        {"plate": "TX-3391", "make": "Scania", "model": "R500", "year": 2020, "type": "Truck", "status": "Available", "odometer": 302180, "fuel_type": "Diesel", "driver": "Daniel Ochieng", "max_load": 15000, "acquisition_cost": 85000, "region": "East"},
        {"plate": "TX-6620", "make": "Renault", "model": "Master", "year": 2022, "type": "Van", "status": "Available", "odometer": 76540, "fuel_type": "Diesel", "driver": "Sofia Rossi", "max_load": 2500, "acquisition_cost": 35000, "region": "South"},
        {"plate": "TX-8834", "make": "Iveco", "model": "Daily", "year": 2019, "type": "Van", "status": "Retired", "odometer": 410500, "fuel_type": "Diesel", "max_load": 2500, "acquisition_cost": 35000, "region": "East"},
        {"plate": "TX-2251", "make": "MAN", "model": "TGX", "year": 2023, "type": "Truck", "status": "Available", "odometer": 61220, "fuel_type": "Diesel", "driver": "Ahmed Al-Farsi", "max_load": 15000, "acquisition_cost": 85000, "region": "West"},
    ]
    
    vehicles_map = {}
    for v in vehicles_data:
        v_obj = Vehicle.objects.create(**v)
        vehicles_map[v["plate"]] = v_obj
        print(f"Created vehicle: {v_obj.plate}")
    ...
    drivers_data = [
        ...
        {"name": "Sofia Rossi", "email": "sofia@transitops.com", "phone": "+39 331 555 8821", "license": "CDL-B", "status": "Available", "rating": 4.9, "trips": 355, "vehicle": "TX-6620", "license_category": "Light Truck", "license_expiry": "2027-12-31"},
    ...
    for d in drivers_data:
        d_obj = Driver.objects.create(**d)
        drivers_map[d["name"]] = d_obj
        print(f"Created driver: {d_obj.name}")
    ...
    for t in trips_data:
        Trip.objects.create(
            vehicle=vehicles_map[t["vehicle"]],
            driver=drivers_map[t["driver"]],
            origin=t["origin"],
    ...
    for m in maintenance_data:
        Maintenance.objects.create(
            vehicle=vehicles_map[m["vehicle"]],
            type=m["type"],
            due_date=m["due_date"],
            cost=m["cost"],
            status=m["status"],
    ...
    for f in fuel_data:
        FuelLog.objects.create(
            vehicle=vehicles_map[f["vehicle"]],
            driver=drivers_map[f["driver"]],
            date=f["date"],
            liters=f["liters"],
            cost=f["cost"],
            odometer=f["odometer"],
    ...
    for e in expenses_data:
        Expense.objects.create(
            date=e["date"],
            category=e["category"],
            vehicle=vehicles_map[e["vehicle"]] if e.get("vehicle") else None,
